...
| markdown-search | Local markdown search and document retrieval | search notes, find docs, knowledge graph query | Workspace markdown files | Search results, document excerpts | None |
...
| nightly-revenue-review | Nightly revenue review and next-day planning | end of day, nightly review, plan tomorrow | Revenue metrics, task completion logs | Daily review summary, next-day plan | None (summary only) |
...
| social-posting-api | Complete GenViral Partner API automation (create/schedule posts across TikTok, Instagram, etc.) | genViral, video post, schedule content, slideshow | GenViral API, content files, video assets | Scheduled posts, asset uploads, analytics | Jeff approves scheduling/spend |
...
| ~~crowd-reply~~ | **[ARCHIVED 2026-07-29]** Reddit engagement via CrowdReply API — decommissioned 2026-06-01, subscription cancelled. Archived to `archive/2026-07-29-cleanup/`. | ~~crowd reply, reddit comment~~ | ~~crowd-reply-training.md~~ | N/A | N/A |
