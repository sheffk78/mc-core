...
export const fremont_caData: TJBCityVideoData = {
  ...
  scenes: [
    ...
    },
    {
      ...
      image_source: "images/fremont-ca-washington-hospital.webp",
      text_content: {
        ...
        description: "Fremont's community hospital delivering ~2,000 babies per year with 24/7 OB hospitalist coverage and a Baby-Friendly designated birthing center. The Special Care Nursery provides advanced care for newborns needing extra monitoring, and doulas are welcome in labor and delivery.",
      },
    },
    {
      ...
      text_content: {
        ...
        description: "One of the region's highest-rated maternity programs located about 15 minutes south of Fremont, with a Level III NICU and a dedicated birth center offering water birth options and private suites. Doulas are welcome, and lactation support is available through IBCLC-certified staff.",
      },
